...
ALIENVAULT_API_URL = "https://otx.alienvault.com/api/v1/pulses/60ece5998a5b54a5ffe75cb4"
ALIENVAULT_HEADERS = {
...
#@api_view(['GET'])
def fetch_and_store_threat_data(request=None):
    if request is None:
    ...
    try:
        ...
        #selected_ips = ip_array[-7:-9:-1] # Example: select the last 2 IPs
